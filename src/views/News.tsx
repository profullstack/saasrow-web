...
export default function NewsPage({ initialNewsItems }: NewsPageProps = {}) {
  const [newsItems, setNewsItems] = useState<NewsItem[]>(initialNewsItems ?? [])
  const [loading, setLoading] = useState(initialNewsItems === undefined)

  useEffect(() => {
    if (initialNewsItems === undefined) {
      fetchNewsPosts()
    }
  }, [initialNewsItems])
